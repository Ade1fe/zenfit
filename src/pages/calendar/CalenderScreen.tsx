...
//       { view: "calendar", icon: Calendar, label: "Calendar", color: "from-emerald-500 to-cyan-500" },
...
//     return (
//       <div className="hidden lg:flex fixed h-full w-20 bg-white flex-col items-center gap-4 py-6 z-50">
//         {menuItems.map(({ view, icon: Icon, label, color }) => (
//           <button
//             key={view}
//             onClick={() => setCurrentView(view as View)}
//             className={`flex flex-col items-center justify-center w-18 p-3 rounded-xl transition-all duration-200 ${
//               currentView === view
//                 ? `bg-gradient-to-b ${color} text-white scale-105`
...
// // // //                 <div>
// // // //                   <div className="text-xl lg:text-2xl font-bold text-emerald-600">{selectedDateTotals.calories}</div>
...
// // //     const menuItems = [
// // //       { view: "dashboard", icon: Home, label: "Dashboard", color: "from-purple-500 to-pink-500" },
// // //       { view: "meal-planner", icon: ChefHat, label: "Meal Plan", color: "from-orange-500 to-red-500" },
// // //       { view: "calendar", icon: Calendar, label: "Calendar", color: "from-emerald-500 to-cyan-500" },
// // //       { view: "food-search", icon: Search, label: "Search", color: "from-green-500 to-emerald-500" },
// // //     ]

// // //     return (
// // //       <div className="hidden lg:flex fixed h-full w-20 bg-white flex-col items-center gap-4 py-6 z-50 border-r border-gray-200">
// // //         {menuItems.map(({ view, icon: Icon, label, color }) => (
// // //           <button
// // //             key={view}
// // //             onClick={() => setCurrentView(view as View)}
// // //             className={`flex flex-col items-center justify-center w-16 p-3 rounded-xl transition-all duration-200 ${
// // //               currentView === view
// // //                 ? `bg-gradient-to-b ${color} text-white scale-105 shadow-lg`
// // //                 : "text-gray-600 hover:text-gray-900 hover:bg-gray-100"
// // //             }`}
// // //           >
// // //             <Icon className="w-5 h-5 mb-1" />
...
// // const CalendarApp = ({ onMealEventsChange }: { onMealEventsChange?: (events: MealEvent[]) => void }) => {
...
// // Change from:
// // const CalendarApp = forwardRef<
// //   { getMealEvents: () => MealEvent[] },
...
const CalendarApp = ({ onMealEventsChange }: { onMealEventsChange?: (events: MealEvent[]) => void }) => {
  ...
  const MobileHeader = () => (
    ...
    return (
      <div className="hidden lg:flex fixed left-0 top-0 h-full w-20 bg-white border-r border-gray-200 flex-col items-center gap-4 py-6 z-50 shadow-sm">
        {menuItems.map(({ view, icon: Icon, label, color }) => (
          <button
            key={view}
            onClick={() => handleViewChange(view)}
            className={`flex flex-col items-center justify-center w-16 h-16 p-3 rounded-xl transition-all duration-200 cursor-pointer ${
              currentView === view
                ? `bg-gradient-to-b ${color} text-white scale-105 shadow-lg`
