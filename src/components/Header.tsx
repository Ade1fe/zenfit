...
//     <>
//       <header
//         className={`bg-white/80 backdrop-blur-lg border-b border-gray-100 shadow-sm transition-all duration-300 fixed top-0 left-0 right-0 z-40 h-16 sm:h-20 ${
...
//                 </div>
//                 <div>
//                   <span className="text-lg sm:text-xl lg:text-2xl font-bold bg-gradient-to-r from-gray-600 to-blue-600 bg-clip-text text-transparent">
...
//                 <Search className="absolute left-3 top-1/2 h-4 w-4 lg:h-5 lg:w-5 -translate-y-1/2 text-gray-400" />
//                 <Input
//                   placeholder={`Search ${currentView === "dashboard" ? "food" : currentView}...`}
//                   className="pl-10 lg:pl-12 pr-10 lg:pr-12 h-10 lg:h-12 rounded-xl border-gray-200 focus:border-gray-400 focus:ring-gray-400 bg-gray-50/50 text-sm lg:text-base"
//                   onChange={handleSearch}
//                 />
//                 <Button
//                   variant="ghost"
//                   size="sm"
//                   className="absolute right-1 lg:right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:bg-gray-100"
//                 >
...
//                 <a
//                   href="#"
//                   className="text-gray-600 hover:text-gray-600 font-medium transition-colors text-sm lg:text-base"
//                 >
//                   Help
//                 </a>
//                 <a
...
//                 <div className="flex items-center space-x-2 lg:space-x-3 bg-gradient-to-r from-gray-100 to-blue-100 rounded-xl px-2 lg:px-3 py-1 lg:py-2 hover:from-gray-200 hover:to-blue-200 transition-all cursor-pointer">
//                   <Avatar className="h-6 w-6 sm:h-8 sm:w-8 ring-2 ring-gray-300">
//                     <AvatarImage src="/placeholder.svg?height=32&width=32" />
//                     <AvatarFallback className="bg-gradient-to-r from-gray-500 to-blue-500 text-white text-xs sm:text-sm">
//                       R
//                     </AvatarFallback>
//                   </Avatar>
...
//           >
//             {/* Mobile Menu Header */}
//             <div className="bg-gradient-to-br from-blue-500 to-gray-600 p-6 text-white">
...
//                   <AvatarFallback className="bg-gradient-to-br from-blue-600 to-gray-600 text-white font-bold">
//                     R
//                   </AvatarFallback>
//                 </Avatar>
//                 <div>
...
//               <Input
//                 placeholder={`Search ${currentView === "dashboard" ? "food" : currentView}...`}
//                 className="pl-10 pr-10 h-10 rounded-xl border-gray-200 focus:border-gray-400 focus:ring-gray-400 bg-gray-50/50"
//                 onChange={handleSearch}
//               />
//               <Button
//                 variant="ghost"
//                 size="sm"
//                 className="absolute right-1 top-1/2 -translate-y-1/2 text-gray-500 hover:bg-gray-100"
//               >
...
//                   <a
//                     href="#"
//                     className="flex items-center gap-3 px-4 py-2 text-sm text-gray-600 hover:text-gray-600 transition-colors"
//                   >
//                     <span>⭐</span>
        ...
        <div className="px-3 sm:px-4 lg:px-6 py-3 sm:py-4">
          <div className="flex items-center justify-between gap-2 sm:gap-4">
            <div className="flex items-center space-x-2 sm:space-x-4">
              ...
              <div className="flex items-center space-x-2 sm:space-x-3">
                {/* <div className="h-8 w-8 sm:h-10 sm:w-10 rounded-xl bg-white shadow  flex items-center justify-center shadow-lg">
                  <span className="text-white text-sm sm:text-lg">
                    {viewEmojis[currentView as keyof typeof viewEmojis] || "🏠"}
                  </span>
                </div> */}
                <div>
                  <span className="text-lg sm:text-xl lg:text-2xl font-bold bg-black bg-clip-text text-transparent">
                    {viewTitles[currentView as keyof typeof viewTitles] || "Dashboard"}
                  </span>
                  {currentView === "dashboard" && (
                    <p className="text-xs sm:text-sm text-gray-500 hidden sm:block">Daily Meal Tracker</p>
            ...
            <div className="hidden md:flex flex-1 max-w-md mx-4 lg:mx-8">
              <div className="relative w-full">
                <Search className="absolute left-3 top-1/2 h-4 w-4 lg:h-5 lg:w-5 -translate-y-1/2 text-gray-700" />
                <Input
                  placeholder={`Search ${currentView === "dashboard" ? "food" : currentView}...`}
                  className="pl-10 lg:pl-12 pr-10 lg:pr-12 h-10 lg:h-12 rounded-xl border-gray-300 focus:border-gray-500 focus:ring-gray-400 bg-gray-50/50 text-sm lg:text-base"
                  onChange={handleSearch}
                />
                <Button
                  variant="ghost"
                  size="sm"
                  className="absolute right-1 lg:right-2 top-1/2 -translate-y-1/2 text-gray-500 hover:bg-gray-400"
                >
                  <Filter className="h-3 w-3 lg:h-4 lg:w-4" />
                </Button>
              </div>
...
>
  <X className="w-8 h-8" />
            ...
            <div className="relative">
              <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-gray-400" />
              <Input
                placeholder={`Search ${currentView === "dashboard" ? "foossssssd" : currentView}...`}
                className="pl-10 pr-10 h-10 rounded-xl border-gray-200 focus:border-gray-400 focus:ring-gray-400 bg-gray-50/50"
                onChange={handleSearch}
              />
              <Button
