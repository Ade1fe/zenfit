...
// // Remove the generateCurrentMealData function and sampleMealPlanData
// // We'll get the real data from the CalendarApp component
...
//     switch (currentView) {
//       case "Calendar":
//         return <CalendarScreen onMealEventsChange={setMealEvents} />
//       case "schedules":
//         return <SchedulesView />
//       case "meals":
//         return <MealsPlansView />
...
//             <div className="mt-6 lg:mt-8 grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-4 lg:gap-6">
//               <div className="lg:col-span-2 xl:col-span-2">
//                 <CaloriesGraph mealPlanData={mealEvents} />
//               </div>
//               <div className="lg:col-span-2 xl:col-span-1">
//                 <ReportSection />
//               </div>
...
//             <div className="mt-6 lg:mt-8 grid grid-cols-1 lg:grid-cols-1 xl:grid-cols-2 gap-4 lg:gap-6">
//               <MealsSection mealPlanData={mealEvents} />
//               <RecommendedFood />
//             </div>
//           </>
//         )
